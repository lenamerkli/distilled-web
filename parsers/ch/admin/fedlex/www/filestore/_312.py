...
DE_PROMPT_ART = '<p>\n  Wie lautet Artikel %ID% der Schweizerischen Strafprozessordnung?\n</p>'
FR_PROMPT_ART = '<p>\n  Quel est le contenu de l\'article %ID% du Code de procédure pénale suisse?\n</p>'
IT_PROMPT_ART = '<p>\n  Qual è il testo dell\'articolo %ID% del Codice di procedura penale svizzero?\n</p>'
