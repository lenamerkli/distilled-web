...
DE_PROMPT_ART = '<p>\n  Wie lautet Artikel %ID% des Schweizerischen Strafgesetzbuch?\n</p>'
FR_PROMPT_ART = '<p>\n  Quel est le contenu de l\'article %ID% du Code pénal suisse?\n</p>'
IT_PROMPT_ART = '<p>\n  Qual è il testo dell\'articolo %ID% del Codice penale svizzero?\n</p>'
